  ...
  return (
    <div className="flex flex-col min-h-full px-4 py-6 pb-24">
      ...
      <button
        ...
        className="fixed bottom-25 right-4 z-40 tap-scale p-3 rounded-full bg-gradient-to-tr from-blue-400 via-purple-500 to-pink-600 shadow-lg shadow-purple-500/40 hover:shadow-purple-500/60 hover:scale-110 transition-all duration-200"
        aria-label="QR Code"
      >
        <svg
          className="w-7 h-7 text-white"
          ...
          viewBox="0 0 24 24"
        >
          <path d="M3 3h8v8H3V3zm2 2v4h4V5H5zm8-2h8v8h-8V3zm2 2v4h4V5h-4zM3 13h8v8H3v-8zm2 2v4h4v-4H5zm13-2h3v2h-3v-2zm-3 0h2v3h-2v-3zm3 3h3v2h-3v-2zm0 3h3v3h-3v-3zm-3 0h2v3h-2v-3zm-1-3h2v2h-2v-2z"/>
        </svg>
      </button>
      ...
      {showQR && (
        ...
        >
          <div
            className="bg-white p-4 rounded-2xl shadow-2xl transform transition-all duration-300 animate-[fadeIn_0.2s_ease-out]"
            onClick={(e) => e.stopPropagation()}
          >
            <img src={qrCode} alt="QR Code" className="w-64 h-64" />
            <p className="text-center text-gray-600 mt-2 text-sm">Podijeli stranicu s prijateljima</p>
          </div>
        </div>
      )}
