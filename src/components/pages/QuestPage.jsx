    ...
    <div className="flex flex-col min-h-full px-4 py-6 pb-24">
      ...
      <div className="flex justify-center mt-6">
        <a
          ...
          className="tap-scale p-3 rounded-full bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 shadow-lg shadow-pink-500/40 hover:shadow-pink-500/60 hover:scale-110 transition-all duration-200"
